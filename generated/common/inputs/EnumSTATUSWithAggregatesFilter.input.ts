...
import { NestedEnumSTATUSWithAggregatesFilter } from "./NestedEnumSTATUSWithAggregatesFilter.input";
import { NestedIntFilter } from "./NestedIntFilter.input";

@NestJsGraphQL.InputType('EnumSTATUSWithAggregatesFilter', { isAbstract: true })
