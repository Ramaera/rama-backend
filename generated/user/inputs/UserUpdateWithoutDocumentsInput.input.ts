...
import { NomineeUpdateOneWithoutUserNestedInput } from "../../nominee/inputs/NomineeUpdateOneWithoutUserNestedInput.input";

@NestJsGraphQL.InputType('UserUpdateWithoutDocumentsInput', { isAbstract: true })
export class UserUpdateWithoutDocumentsInput {
  ...
  @NestJsGraphQL.Field(() => NomineeUpdateOneWithoutUserNestedInput, { nullable: true })
  nominee?: NomineeUpdateOneWithoutUserNestedInput | undefined;
