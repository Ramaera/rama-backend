...
-- CreateIndex
CREATE UNIQUE INDEX "Nominee_userPw_id_key" ON "Nominee"("userPw_id");

-- AddForeignKey
ALTER TABLE "Document" ADD CONSTRAINT "Document_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Nominee" ADD CONSTRAINT "Nominee_userPw_id_fkey" FOREIGN KEY ("userPw_id") REFERENCES "User"("pw_id") ON DELETE RESTRICT ON UPDATE CASCADE;
