...
const SeedCommand = async () => {
  const hashedPassword = await HashedPassword('Bhargav12');
  // const filePath =
  //   '/Users/apple/Documents/ramaera_dashboard/rama-backend/prisma/HajipurProject.csv';
  // const results = [];
  // fs.createReadStream(filePath)
  //   .pipe(csv())
  //   .on('data', (data) => results.push(data));
